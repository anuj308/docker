...
Original Repository: [https://github.com/heroku/nodejs-getting-started](https://github.com/heroku/nodejs-getting-started)

**Assignment Q2 (Practical - 20 Marks): Docker Implementation**
- ✅ Repository cloned locally
- ✅ Dockerfile created
- ✅ Docker image built (`node-js-getting-started:latest`)
- ✅ Container run with port mapping (port 5006)
- ✅ Custom Docker network created (`mynet`)
- ✅ Second container deployed for network communication testing
- ⚠️ Image push to Docker Hub: Attempted but incomplete (see [Dockerfile](./Dockerfile))

**Documentation:** Screenshots and step-by-step evidence available in [anujsharma40docker.pdf](./anujsharma40docker.pdf)
